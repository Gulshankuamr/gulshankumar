...
export default function WorkShowcaseSnapping() {
  ...
  const projects: Project[] = [
    // ... aapka projects array same as previous code
  ];
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      projectRefs.current.forEach((ref, i) => {
        ...
        const dist = Math.abs(center - projectCenter);
        if (dist < minDist) {
          minDist = dist;
          closest = i;
        }
      ...
      setActiveProject((prev) => (prev !== closest ? closest : prev));
    };
  ...
  return (
    <div className="bg-black pt-20 md:pt-8 w-full text-white">
      <div className="pt-5 px-4 md:px-10 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row">
                ...
                >
                  <div className={`bg-gradient-to-b ${project.bgGradient} rounded-xl`}>
                    ...
                    <div className="p-4">
                      ...
                      <button
                        onClick={() => toggleExpandedMobile(idx)}
                        className="flex items-center text-xs text-gray-300 font-medium"
                      >
                        {expandedMobile === idx ? "Show less" : "Show more"}
                        {expandedMobile === idx ? (
          ...
          {/* Right: Details */}
          <div className="hidden md:block md:w-1/2 sticky top-0 h-screen flex items-center">
              ...
              >
                ...
                <div className="space-y-4">
                  {projects[activeProject].features.map((f, i) => (
                    ...
                    >
                      <span
                        className={`${projects[activeProject].accentColor.replace(
                          "bg-",
                          "text-"
                        )} mt-1`}
                      >
