...
export default function WorkShowcaseSnapping() {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      image: videochatapp, // Replace this with your imported image reference
    ...
    },
    {
      ...
      title: "Portfolio",
      tagline:
        "Dynamic and interactive portfolio showcasing my work and skills.",
      description:
...

    {
      ...
      title: "PicResizer",
      tagline:
        "Resize, compress, and convert images instantly with just a few clicks.",
      description:
...

    {
      ...
      tagline:
        "Experience a visually stunning, interactive website powered by GSAP animations and React UI.",
      description:
  ...
  return (
    <div
      ref={componentRef}
      className="bg-black pt-20 md:pt-8 w-full text-white"
    >
            ...
            <div className="w-full md:w-1/2">
              ...
              <div className="md:hidden space-y-8 my-8">
                {projects.map((project, index) => (
                  ...
                  >
                    <div
                      className={`bg-gradient-to-b ${project.bgGradient} rounded-xl`}
                    >
                      {/* Project Image */}
                            ...
                            >
                              ...
                              <div className="space-y-2">
                                ...
                                {project.features.map((feature, i) => (
                                  ...
                                  >
                                    <span
                                      className={`${project.accentColor.replace(
                                        "bg-",
                                        "text-"
                                      )} text-xs mt-1`}
                                    >
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className="flex items-center gap-2 mb-4">
                      <div
                        className={`h-1 w-10 ${projects[activeProject].accentColor}`}
                      ></div>
                      ...
                      {projects[activeProject].features.map((feature, i) => (
                        ...
                        >
                          <span
                            className={`${projects[
                              activeProject
                            ].accentColor.replace("bg-", "text-")} mt-1`}
                          >
                            +
                          </span>
                    ...
                    <div className="mt-10">
                      <div className="flex flex-wrap gap-3">
                        {projects[activeProject].techStack
                          .slice(0, 12)
                          .map((tech, i) => (
                            <motion.div
                              key={i}
